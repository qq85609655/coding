...
if (!window.af || "function" !== typeof af) {
	var af = function(g) {
		...
		function E(a, c) {
			...
			a.feat.nativeTouchScroll = "undefined" !== typeof b.style["-webkit-overflow-scrolling"] && (a.os.ios || a.os.blackberry10);
		...
		function P(a, c, b, d) {
			...
			return (l[v(a)] || []).filter(function(a) {
		...
		function V(a, c, b, d) {
			w(a, c, b, d, function(b) {
				return function(c) {
					var f, g = e(c.target).closest(d, a).get(0);
					if (g) return f = e.extend(R(c), {
						currentTarget: g,
						liveFired: a
					}), b.apply(g, [f].concat([].slice.call(arguments, 1)))
				}
			})
		}
		...
		function H(a, c) {
			...
			if ((b = v(a)) && l[b]) {
				for (var d in l[b]) a.removeEventListener(l[b][d].e, l[b][d].proxy, !1);
				delete l[b]
			}
		}
		...
		e.map = function(a, c) {
			...
			if (e.isArray(a))
				...
				for (k in a) a.hasOwnProperty(k) && "length" != k && (b = c(a[k], k), b !== f && d.push(b));
			return af([d])
		};
		e.each = function(a, c) {
			var b;
			if (e.isArray(a))
				...
				for (b in a)
					if (a.hasOwnProperty(b) && "length" != b && !1 === c(b, a[b])) break;
			return a
		};
		e.extend = function(a) {
			a == f && (a = this);
		...
		e.fn = m.prototype = {
			...
			selector: function(a, c) {
				a = a.trim();
				if ("#" === a[0] && -1 == a.indexOf(".") && -1 == a.indexOf(",") && -1 === a.indexOf(" ") && -1 === a.indexOf(">")) c == h ? s(c.getElementById(a.replace("#", "")), this) : s(D(a, c), this);
			...
			toggle: function(a) {
				if (0 === this.length) return this;
				for (var c = !0 === a, b = 0; b < this.length; b++)
					if ("none" != this.css("display", null, this[b]) && (a == f || !1 === c)) this[b].setAttribute("afmOldStyle", this.css("display", null, this[b])), this[b].style.display = "none";
					else if ("none" == this.css("display", null, this[b]) && (a == f || !0 === c)) this[b].style.display = this[b].getAttribute("afmOldStyle") ? this[b].getAttribute("afmOldStyle") : "block", this[b].removeAttribute("afmOldStyle");
				return this
			},
			val: function(a) {
			...
			attr: function(a, c) {
				...
				if (c === f && !e.isObject(a)) return this[0].afmCacheId && n[this[0].afmCacheId][a] ? this[0].afmCacheId && n[this[0].afmCacheId][a] : this[0].getAttribute(a);
				for (var b = 0; b < this.length; b++)
					if (e.isObject(a))
						for (var d in a) e(this[b]).attr(d, a[d]);
					else e.isArray(c) || e.isObject(c) || e.isFunction(c) ? (this[b].afmCacheId || (this[b].afmCacheId = e.uuid()), n[this[b].afmCacheId] || (n[this[b].afmCacheId] = {}), n[this[b].afmCacheId][a] = c) : null === c ? (this[b].removeAttribute(a), this[b].afmCacheId && n[this[b].afmCacheId][a] && delete n[this[b].afmCacheId][a]) : this[b].setAttribute(a, c);
				return this
			},
			...
			prop: function(a, c) {
				...
				for (b = 0; b < this.length; b++)
					...
					else e.isArray(c) || e.isObject(c) || e.isFunction(c) ? (this[b].afmCacheId || (this[b].afmCacheId = e.uuid()), q[this[b].afmCacheId] || (q[this[b].afmCacheId] = {}), q[this[b].afmCacheId][a] = c) : null === c && void 0 !== c ? e(this[b]).removeProp(a) : this[b][a] = c;
				return this
			},
			...
			remove: function(a) {
				a = e(this).filter(a);
				if (a == f) return this;
				for (var c = 0; c < a.length; c++) e.cleanUpContent(a[c], !0, !0), a[c] && a[c].parentNode && a[c].parentNode.removeChild(a[c]);
				return this
			},
			addClass: function(a) {
				if (a == f) return this;
			...
			toggleClass: function(a, c) {
				if (a == f) return this;
				for (var b = 0; b < this.length; b++) "boolean" != typeof c && (c = this.hasClass(a, this[b])), e(this[b])[c ? "removeClass" : "addClass"](a);
				return this
			},
			...
			append: function(a, c) {
				...
				for (b = 0; b < this.length; b++)
					if (a.length && "string" != typeof a) a = e(a), B(a, this[b], c);
						...
						var d = X.test(a) ? e(a) : void 0;
						if (d == f || 0 === d.length) d = h.createTextNode(a);
						d.nodeName != f && "script" == d.nodeName.toLowerCase() && (!d.type || "text/javascript" === d.type.toLowerCase()) ? g.eval(d.innerHTML) : d instanceof m ? B(d, this[b], c) : c != f ? this[b].insertBefore(d, this[b].firstChild) : this[b].appendChild(d)
					}
				return this
			},
			...
			parent: function(a, c) {
				...
				for (var b = [], d = 0; d < this.length; d++)
					for (var f = this[d]; f.parentNode && f.parentNode != h && !(b.push(f.parentNode), f.parentNode && (f = f.parentNode), !c););
			...
			serialize: function() {
				...
				for (var a = [], c = 0; c < this.length; c++) this.slice.call(this[c].elements).forEach(function(b) {
					...
					if ("fieldset" != b.nodeName.toLowerCase() && (!b.disabled && "submit" != c && "reset" != c && "button" != c && ("radio" != c && "checkbox" != c || b.checked)) && b.getAttribute("name"))
		...
		e.ajax = function(a) {
			...
			try {
				...
				var f, h = b.context,
					m = /^([\w-]+:)\/\//.test(b.url) ? RegExp.$1 : g.location.protocol;
				...
				c.onreadystatechange = function() {
					...
					if (4 === c.readyState) {
						clearTimeout(f);
						var d, g = !1;
						if (200 <= c.status && 300 > c.status || 0 === c.status && "file:" == m) {
							...
							g ? b.error.call(h, c, "parsererror", g) : b.success.call(h, d, "success", c)
						} else g = !0, b.error.call(h, c, "error");
						b.complete.call(h, c, g ? "error" : "success")
					}
				};
				...
				if (!1 === b.beforeSend.call(h, c, b)) return c.abort(), !1;
				0 < b.timeout && (f = setTimeout(function() {
					c.onreadystatechange = t;
					c.abort();
					b.error.call(h, c, "timeout")
				}, b.timeout));
				c.send(b.data)
			} catch (n) {
				console.log(n), b.error.call(h, c, "error", n)
			}
			return c
		};
		e.get = function(a, c) {
		...
		e.getCssMatrix = function(a) {
			e.is$(a) && (a = a.get(0));
			var c = g.WebKitCSSMatrix || g.MSCSSMatrix;
			if (a === f) return c ? new c : {
				a: 0,
				b: 0,
				c: 0,
				d: 0,
			...
			a = a.webkitTransform || a.transform || a[e.feat.cssPrefix + "Transform"];
			return c ? new c(a) : a ? (c = a.replace(/[^0-9\-.,]/g, "").split(","), {
				a: +c[0],
				b: +c[1],
				c: +c[2],
				d: +c[3],
		...
		e.fn.delegate = function(a, c, b) {
			for (var d = 0; d < this.length; d++) V(this[d], c, b, a);
			return this
		};
		...
		e.bind = function(a, c, b) {
			if (a) {
				...
				e.isArray(c) || (c = [c]);
				for (var d = 0; d < c.length; d++) a.__events[c[d]] || (a.__events[c[d]] = []), a.__events[c[d]].push(b)
			}
		};
		e.trigger = function(a, c, b) {
			if (a) {
				...
				for (var f = 0; f < c.length; f++)
					if (a.__events[c[f]])
						for (var g = a.__events[c[f]].slice(0), h = 0; h < g.length; h++) e.isFunction(g[h]) && !1 === g[h].apply(a, b) && (d = !1);
				return d
			}
		};
		...
		e.cleanUpContent = function(a, c, b) {
			if (a) {
				var d = a.childNodes;
				d && 0 < d.length && e.asap(Y, {}, [J.apply(d, [0]), b]);
				c && H(a, b)
			}
		};
		var A = [],
		...
		g.addEventListener("message", function(a) {
			a.source == g && "afm-asap" == a.data && (a.stopPropagation(), 0 < A.length && A.shift().apply(L.shift(), M.shift()))
		}, !0);
		var N = {};
